...
CREATE TABLE `membershiptypes` (
  ...
  `SignupFee` smallint(6) NOT NULL,
  `DurationInMonths` tinyint(3) unsigned NOT NULL,
  `DiscountRate` tinyint(3) unsigned NOT NULL,
...
INSERT INTO `membershiptypes` VALUES (1,0,0,0,'Free'),(2,30,1,10,'Pay as you go'),(3,90,3,15,'Quarterly'),(4,300,12,20,'Annually');
...
-- Dump completed on 2017-05-09 19:10:36
